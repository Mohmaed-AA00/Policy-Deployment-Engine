...
Example:
    >>> from scripts.docgen.lib.logging_config import setup_logging
    >>> import logging
...
def setup_logging(silent: bool = False) -> Path:
    ...
    - Location: scripts/docgen/logs/generator-{timestamp}.log
    ...
    package_logger = logging.getLogger("scripts.docgen")

...
|----------|-------------|----------|-----------------|-----------|-----------|---------------|
| `discovered_service` | Immutable. The resource name of the original discovered service. | true | false | None | None | None |
...
| `service_id` | The Service identifier. | true | false | None | None | None |
| `display_name` | User-defined name for the Service. | false | false | None | None | None |
| `description` | User-defined description of a Service. | false | false | None | None | None |

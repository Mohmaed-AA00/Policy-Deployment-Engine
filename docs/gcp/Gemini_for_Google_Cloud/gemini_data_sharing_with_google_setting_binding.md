...
| `data_sharing_with_google_setting_id` | Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122. | true | true | Determines the ID. Not security-related | ['c', 'c1', 'c2'] | Anything  else |
| `setting_binding_id` | Required. Id of the setting binding. | true | false | Not security-related. | None | None |

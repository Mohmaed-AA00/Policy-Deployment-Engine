resource "google_apihub_plugin_instance" "compliant_example_1" {
  project = "PDE"
  location = "us-central1"
  plugin = "existing-plugin-id-c1"
  plugin_instance_id = "compliant_example_1"
...
resource "google_apihub_plugin_instance" "compliant_example_2" {
  project = "PDE"
  location = "us-central1"
  plugin = "existing-plugin-id-c2"
  plugin_instance_id = "compliant_example_2"

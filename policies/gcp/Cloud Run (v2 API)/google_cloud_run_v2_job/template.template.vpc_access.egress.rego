package terraform.gcp.security.cloud_run_v2_api.google_cloud_run_v2_job.template_template_vpc_access_egress
...
conditions := [
    ...
    "remedies":[ "Restrict egress to PRIVATE_RANGES_ONLY"]},
    {
        ...
        "attribute_path" : ["template",0,"template",0,"vpc_access",0,"egress"],
        "values" : ["ALL_TRAFFIC"],

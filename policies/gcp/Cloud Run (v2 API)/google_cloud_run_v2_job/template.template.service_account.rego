package terraform.gcp.security.cloud_run_v2_api.google_cloud_run_v2_job.template_template_service_account
...
conditions := [
    ...
    },
    {
        ...
        "attribute_path": ["template",0,"template",0,"service_account"],
        "values": ["",null],

package terraform.gcp.security.backup_and_dr_service.google_backup_dr_restore_workload.compute_instance_restore_properties_shielded_instance_config_enable_vtpm

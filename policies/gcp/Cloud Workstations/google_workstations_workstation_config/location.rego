package terraform.gcp.security.cloud_workstations.google_workstations_workstation_config.location
...
conditions := [
    ...
    {
        "condition": "c1 : check the cloud workstation config location",

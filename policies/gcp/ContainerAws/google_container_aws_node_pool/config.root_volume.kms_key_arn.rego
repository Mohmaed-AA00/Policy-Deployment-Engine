package terraform.gcp.security.containeraws.google_container_aws_node_pool.config_root_volume_kms_key_arn
...
conditions := [[
  {
    "situation_description": "Node pool root volume is encrypted with an unapproved AWS KMS key.",
  ...
  },
  {
    ...
    "attribute_path": ["config", 0, "root_volume", 0, "kms_key_arn"],

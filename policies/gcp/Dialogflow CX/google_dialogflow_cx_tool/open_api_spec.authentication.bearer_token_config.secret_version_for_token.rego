package terraform.gcp.security.dialogflow_cx.google_dialogflow_cx_tool.open_api_spec_authentication_bearer_token_config_secret_version_for_token
...
secret_version_path := ["open_api_spec", 0, "authentication", 0, "bearer_token_config", 0, "secret_version_for_token"]
...
message := [
  ...
  "Situation 1: Dialogflow CX Tool bearer-token credentials must use a Secret Manager secret version.",
  sprintf("Non-Compliant Resources: %s", [non_compliant_display]),
  "Potential Remedies: Set secret_version_for_token to projects/{project}/secrets/{secret}/versions/{version}."
]

details := [{
  "situation": "Dialogflow CX Tool bearer-token credentials must use a Secret Manager secret version.",
  "remedies": ["Set secret_version_for_token to projects/{project}/secrets/{secret}/versions/{version}."],

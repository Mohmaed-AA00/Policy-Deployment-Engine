package terraform.gcp.security.google_network_services_lb_route_extension.deletion_policy
...
conditions := [
    [
        {
            "situation_description": "The LB Route Extension should prevent accidental or unauthorized deletion.",
            "remedies": [

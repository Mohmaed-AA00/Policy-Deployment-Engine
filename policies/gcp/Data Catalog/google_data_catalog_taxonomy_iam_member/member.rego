package terraform.gcp.security.google_data_catalog.google_data_catalog_taxonomy_iam_member.member
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_taxonomy_iam_member.vars

conditions := [
    [
    {"situation_description" : "Data Catalog taxonomy IAM member allows public access.",

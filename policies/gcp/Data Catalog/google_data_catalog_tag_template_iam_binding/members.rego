package terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_binding.members
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_binding.vars

conditions := [
    [
    {"situation_description" : "Data Catalog tag template IAM binding contains public members.",

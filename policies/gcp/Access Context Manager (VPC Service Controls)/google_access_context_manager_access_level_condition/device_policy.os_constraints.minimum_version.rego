package terraform.gcp.security.access_context_manager_vpc_service_controls.google_access_context_manager_access_level_condition.device_policy_os_constraints_minimum_version
...
conditions := [[
	...
	},
	{
		...
		"attribute_path": ["device_policy", 0, "os_constraints", 0, "minimum_version"],
		"values": ["10.0.0"],

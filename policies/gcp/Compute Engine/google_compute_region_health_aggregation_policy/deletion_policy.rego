package terraform.gcp.security.compute_engine.google_compute_region_health_aggregation_policy.deletion_policy

import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_region_health_aggregation_policy.vars

package terraform.gcp.security.compute_engine.google_compute_global_network_endpoint_group.deletion_policy

import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_global_network_endpoint_group.vars

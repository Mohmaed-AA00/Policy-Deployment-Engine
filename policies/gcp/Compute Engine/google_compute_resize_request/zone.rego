package terraform.gcp.security.compute_engine.google_compute_resize_request.zone
...
conditions := [
	[
		{
			"situation_description": "Resize request is outside the approved Australian zones.",
			"remedies": [

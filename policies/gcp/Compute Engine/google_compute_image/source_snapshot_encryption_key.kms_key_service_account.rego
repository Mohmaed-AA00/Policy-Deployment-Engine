...
conditions := [
	[
		{
			"situation_description": "The source snapshot encryption configuration does not use a structurally valid service account.",
			"remedies": [
				"Set source_snapshot_encryption_key.kms_key_service_account to a valid IAM service-account email.",
			],
		},
		{
			"condition": "A source snapshot KMS service account must be configured.",

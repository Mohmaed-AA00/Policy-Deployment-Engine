...
conditions := [
    [
        {
            "situation_description": "Compute disk uses a raw customer-supplied encryption key (CSEK), which creates key-exposure and secret-sprawl risks.",
            "remedies": ["Remove disk_encryption_key.raw_key and use disk_encryption_key.kms_key_self_link (CMEK) instead."]
        },
        {
            "condition": "disk_encryption_key.raw_key should not be used.",

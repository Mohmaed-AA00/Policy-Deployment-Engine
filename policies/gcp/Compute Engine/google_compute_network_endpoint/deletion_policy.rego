package terraform.gcp.security.compute_engine.google_compute_network_endpoint.deletion_policy

import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_network_endpoint.vars

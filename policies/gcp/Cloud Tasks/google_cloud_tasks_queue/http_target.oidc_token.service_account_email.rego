package terraform.gcp.security.cloud_tasks.google_cloud_tasks_queue.http_target_oidc_token_service_account_email
...
conditions := [
    [
        {
            "situation_description": "A default Google-managed service account is being used to generate OIDC tokens for Cloud Tasks requests.",
            "remedies": [
        ...
        {
            "condition": "OIDC token service_account_email must not use a default Google-managed service account.",

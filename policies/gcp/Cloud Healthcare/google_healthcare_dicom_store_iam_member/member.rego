package terraform.gcp.security.cloud_healthcare.google_healthcare_dicom_store_iam_member.member
...
conditions := [
  [
    {
      "situation_description": "DICOM Store IAM member must not be allUsers or allAuthenticatedUsers — grants public access to medical imaging data",
      "remedies": [

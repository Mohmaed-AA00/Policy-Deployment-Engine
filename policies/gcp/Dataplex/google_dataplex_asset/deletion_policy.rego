...
conditions := [
    [
        {
            "situation_description": "If the deletion_policy attribute is not set to 'PREVENT', the Dataplex asset may be accidentally or unintentionally deleted through Terraform operations.",
